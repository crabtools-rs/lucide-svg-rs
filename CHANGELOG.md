...
## [0.2.0](https://github.com/crabtools-rs/lucide-svg-rs/compare/v0.1.8...v0.2.0) (2025-11-22)


### Features

* read icons from compressed tar.gz instead of directory ([16be714](https://github.com/crabtools-rs/lucide-svg-rs/commit/16be7146cd80e35f6c705f9199d53bc874993f07))
...
* correct GitHub Actions secrets syntax and ensure icons.tar.gz is included ([15a2e45](https://github.com/crabtools-rs/lucide-svg-rs/commit/15a2e45c039f0986da14507054f0fdc454b93dac))
* correct repository owner in cargo-publish workflow ([581ceee](https://github.com/crabtools-rs/lucide-svg-rs/commit/581ceeefed65d48ff1b05d1977dda21984f0dd06))
